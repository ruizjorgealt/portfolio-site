...
--------------------------------------*/
	...
	$options[] = array(
		'desc' => __( '<strong>Main Area</strong>', 'frontier' ),
		'id' => 'color_main',
		'type' => 'color',
		'std' => '#F5F5F5' );

	$options[] = array(
		'desc' => __( '<strong>Posts</strong>', 'frontier' ),
		'id' => 'color_posts',
		'type' => 'color',
		'std' => '#FFFFFF' );

	$options[] = array(
		'desc' => __( '<strong>Sticky Posts</strong>', 'frontier' ),
		'id' => 'color_sticky_posts',
		'type' => 'color',
		'std' => '#FFDC8A' );

	$options[] = array(
		'desc' => __( '<strong>Widgets</strong>', 'frontier' ),
		'id' => 'color_widgets',
		'type' => 'color',
		'std' => '#FFFFFF' );
